...
MODULE_AUTHOR("Khandeldy Oleksii IV-91");
...
struct List *var_1, *var_2;

head = kmalloc(sizeof(struct List *), GFP_KERNEL);
...
for (i = 0; i < amount; i++) {
	var_1->next = kmalloc(sizeof(struct List), GFP_KERNEL);
